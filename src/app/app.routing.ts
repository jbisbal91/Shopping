  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "store",
        loadChildren: () =>
        import("./views/sessions/store/store.module").then((m) => m.StoreModule)
      },
      {
        path: "buy/products",
        loadChildren: () =>
        import("./views/sessions/store/components/buy-product/buy-product.module").then((m) => m.BuyProductModule)
      },
    ],
  },
  {
